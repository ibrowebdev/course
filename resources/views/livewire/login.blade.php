<div class="flex justify-center items-center">
    ...
    <div class="w-full max-w-xl p-6  sm:p-8 bg-white rounded-lg shadow dark:bg-gray-800 mt-4">
        ...
        <form class="mt-8 ">
            ...
            <button wire:click.prevent="login" type=""
                class="w-auto px-5 py-3 text-base font-medium text-center text-white bg-indigo-600 rounded-md hover:bg-indigo-700 focus:ring-4 focus:ring-blue-300 sm:w-auto dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-2">Login</button>
            @if (session('register'))
